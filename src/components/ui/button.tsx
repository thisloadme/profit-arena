...
const variants: Record<Variant, string> = {
  primary: "bg-primary text-white hover:bg-primary-hover active:brightness-90 border border-transparent",
  ...
  danger: "bg-loss text-white hover:opacity-90 active:opacity-80 border border-transparent",
};
